...
Время с момента начала пересылки до того, как последний пакет пройдёт первое соединение это $\frac{5МБ}{200Кбит/с} = \frac{40\times1024 }{200} = 204.8$сек 

Итого, ответ: 204.8сек + 5/6*$L$
